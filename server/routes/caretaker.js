...
const { signIn, signUp, currentActivities, pendingRequests, getPastActivities, acceptRequest, declineRequest, caretakerDetails, updateDetails } = require('../controllers/caretaker.js');
...
router.get('/details', caretakerDetails);
